  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        ReservationRestaurantScreen.route: (context) => const ReservationRestaurantScreen(),
        DetailReservationRestaurantScreen.route: (context) => DetailReservationRestaurantScreen(),
      },
    );
  }
}